...
class StormTrade13MerchantCreationServiceTest {
    ...
    void bodyShouldBuildRequestObject(String gatewayUrl, String secret) {
        ...
        detailsRequest.setMethods(List.of(BotDetailsRequest.MerchantMethod.builder().merchant(Merchant.STORM_TRADE_13).method(Collections.singletonList("SBP")).build()));
