...
public class DaoPaymentsOrderCreationService extends MerchantOrderCreationService<Response, Callback> {
    ...
    protected Request body(OrderCreationRequest request) {
        ...
        requestBody.setMerchantOrderId(UUID.randomUUID().toString());
        requestBody.setRequisiteType(parseMethod(request.getMethod(), Method.class));
        ...
        requestBody.setSuccessUrl(callbackUrl);
        requestBody.setFailUrl(callbackUrl);
        return requestBody;
    }
    ...
    protected Optional<DetailsResponse> buildResponse(Response response) {
        ...
        detailsResponse.setBank(transferDetails.getBankName());
        detailsResponse.setDetails(transferDetails.getCardNumber());
